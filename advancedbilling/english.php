...
$LANG['configuration']['bill_on_terminate_help']            =   'Bill your client after the account is terminated ';
$LANG['configuration']['billing_type']                      =   'Billing Type';
$LANG['configuration']['billing_type_help']                 =   '';
$LANG['configuration']['bill_on_invoice_generate']          =   'Bill On Invoice';
$LANG['configuration']['bill_on_specific_day']              =   'Bill On Specific Day';
$LANG['configuration']['bill_every_x_days']                 =   'Bill Every X Days';
$LANG['configuration']['billing_type_value']                =   'Billing Type Value';
$LANG['configuration']['billing_type_value_help']           =   '';
$LANG['configuration']['due_date']                          =   'Due Date';
$LANG['configuration']['due_date_help']                     =   'Days (7 by default)';
$LANG['configuration']['autogenerate_invoice']              =   'Auto Generate Invoice';
...
$_LANG['addonAA']['Graphs']['Graph extension allows you to view graphs of usage records for every configured services in Advanced Billing'] = 'Graph extension allows you to view graphs of usage records for every configured service in Advanced Billing module';
...
$_LANG['CreditBilling']['Enable to automatically charge from a credit card'] = 'Enable to automatically charge the client\'s credit card';
$_LANG['CreditBilling']['Auto Refill Value'] = 'Auto Refill Value';
$_LANG['CreditBilling']['How much should be refiled in a single refill operation'] = 'The amount to be refilled in a single refill operation';
$_LANG['CreditBilling']['Auto Refill Under'] = 'Auto Refill Under';
$_LANG['CreditBilling']['Refil if your credit balance falls below this value'] = 'Refill if your credit balance falls below this value';
$_LANG['CreditBilling']['Save'] = 'Save';
$_LANG['CreditBilling']['Wrong value. Value cannot be lower than 0'] = 'The value cannot be lower than 0';
$_LANG['CreditBilling']['Wrong value. Value cannot be lower than x'] = 'The value cannot be lower than x';
$_LANG['CreditBilling']['Wrong value. Value cannot be greater x'] = 'The value cannot be greater than x';
$_LANG['CreditBilling']['Configuration has been saved'] = 'The configuration has been saved successfully';
$_LANG['CreditBilling']['Auto Refill'] = 'Auto Refill';
$_LANG['CreditBilling']['Value cannot be higher then '] = 'The value cannot be higher than ';
$_LANG['CreditBilling']['Value cannot be lower then '] = 'The value cannot be lower than ';
...
$_LANG['addonAA']['CreditBilling']['Client credits has been refunded'] = 'Client credits have been refunded successfully';
...
$_LANG['addonAA']['configuration']['To enable product in Advanced Billing module please select it in field below'] = 'Select products that should be enabled in Advanced Billing module:';
...
$_LANG['addonAA']['configuration']['Show Billing Cycle Information from Advanced Billing Module'] = 'Show the billing cycle information from Advanced Billing module';
 ...
 *  Items
 */
$_LANG['addonAA']['items']['Item list will show you current usage counted by the Advanced Billing module for accounts'] = 'The items list includes products the current usage of which is counted by Advanced Billing module';
...
$_LANG['addonAA']['configuration']['Check this option if you want to enable Credit Billing for this product'] = 'Check this option if you want to enable the Credit Billing for this product';
...
$_LANG['addonAA']['configuration']['Set email interval for email notification'] = 'Set the time interval for email notifications';
...
$_LANG['addonAA']['configuration']['Check this option if you want to enable Graph Extension for this product'] = 'Check this option if you want to enable the Graph Extension for this product';
...
$_LANG['addonAA']['settings']['Archive Flush Interval Saved']  = "Saving of the flush interval has failed";
...
$_LANG['addonAA']['settings']['Credit Billings']  = "Credit Billings";
$_LANG['addonAA']['settings']['Extension used to charge clients for their products from their credit balance']  = "Extension used to charge clients for their products from their credit balance";
...
$_LANG['addonAA']['settings']['Extension used to automatically scale server cloud depend on its load'] = 'Extension used to automatically scale server cloud depend on its load';

$_LANG['addonAA']['settings']['Product Auto Upgrade'] = 'Product Auto Upgrade';
$_LANG['addonAA']['settings']['Extension used to automatically upgrade products basing on resource usage'] = 'Extension used to automatically upgrade products basing on resource usage';